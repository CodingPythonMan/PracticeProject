...
public class BoardController {
	private java.util.logging.Logger log=LoggerFactory.getLogger(BoardController.class);
	 ...
	 *      String로 return 값을 "성공 or실패"를 리턴 할수도 있다.(현재 문자열 리턴)
	 * 참고 : @ResponseBody는  전달된 뷰를 통해서 출력하는 것이 아니라
	 *       HTTP ResponseBody에 직접 출력하는 방식.
	 *       produces 속성은 지정한 미디어 타입과 관련된 응답을 생성하는데 사용한 실제
	 *       컨텐트 타입을 보장.
	 *****************************/
	@ResponseBody
